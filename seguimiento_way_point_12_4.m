...
initPose = [4;1;180];             % Initial pose (x y theta)
pose = zeros(3,numel(tVec));    % Pose matrix
pose(:,1) = initPose;

% Define waypoints
waypoints = [4,1;2,3; 0,3; 2,1; 6,1; 8,3; 6,3; 4,1; 4,5; 3,6; 3,8; 5,8; 5,6; 4,5; 6,3; 6,5; 8,5; 6,7; 8,9; 6,9; 6,11; 4,9; 2,11; 2,9; 0,9; 2,7; 0,5; 2,5; 2,3; 4,5]; %definidos por el profesor. 
